...
-- ============================================
-- Ejecuta este script DESPUÉS de ejecutar 1_BORRAR_TODO.sql
...
-- Función que se ejecuta cuando se registra un usuario
...
-- ✅ Trigger de registro: Crea automáticamente el jugador al registrarse
-- 
-- Listo para:
